...
const checkFileTypeOnDBLClick = event => {
  getFilesFromDB().then(res => {
    ...
    if (target.classList.contains('shortcut')) {
      new _Classes__WEBPACK_IMPORTED_MODULE_1__.Program('browser').openBrowser('https://sof7ik.github.io/metallomer.ru/', 'browser');
    }
...
class Program {
  ...
  openSettings(what) {
    ...
    this.element.insertAdjacentHTML('afterbegin', `
        <aside class="left">
            ...
            <aside class="right">
                ...
                <div class="choosen">
                    <form enctype="multipart/form-data" class="choose-form" action="./php/files.php?userId=${(0,_desktop__WEBPACK_IMPORTED_MODULE_0__.getUserInfo)(window.location.href).id}" method="POST">
    ...
    (0,_settings__WEBPACK_IMPORTED_MODULE_1__.imageHandler)();
  } //закрытие программы
